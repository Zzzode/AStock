---
name: source-governance-analyst
description: Controls source hierarchy, source registry, claim audit, and whether claims may enter valuation
...
`claim | company | customer/platform | source file | original URL | source type | confidence | used in valuation? | adopted wording`
