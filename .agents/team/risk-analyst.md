...
- Competitive landscape, full-chain taxonomy, core/satellite classification, value-chain economics, and variant perception for deep industry-chain reports
...
## Variant Perception Stress Test
| Consensus Claim | AStock View | Strongest Opposing Argument | Evidence That Would Prove AStock Wrong | Monitoring Trigger |
...
- In deep research, write or cross-check `analysis/variant_perception.md`; the strongest opposing argument must be specific enough to change the investment stance if proven.
