...
\newcommand{\reporthouseview}{\kaishu 光通信不是只有光模块。本报告把产业链拆成材料/基底、制造设备、光芯片、光器件、光模块、光纤光缆、网络设备和下游应用八层，覆盖 25 只可估值 A 股标的并逐一给出当前价、内在价值锚、市场情绪锚、综合目标价、空间和动作；低纯度、亏损或利润分母过薄的链条公司进入观察池。组合权重市场共识调整后空间为 \textbf{-23.3\%}，内在价值锚空间为 -47.1\%。结论是精选已兑现利润分母的模块龙头，同时承认通鼎互联、中天科技、长飞光纤等慢周期链条公司存在可观察市场情绪溢价。}
