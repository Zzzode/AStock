        ...
        \newcommand{\reportquality}{行情和财务来自本地能力层；产能、收入占比和订单边界以公司公告或产品页为主；券商观点使用公开PDF/转载，未接入付费一致预期库。}
        ...
        \small
        本报告由本地研究系统基于公开资料和本地能力层生成。报告中任何目标价、评级、行动标签和情景假设均用于研究框架和监测优先级，不构成投资建议。投资有风险，市场价格可能大幅偏离模型估值。
        \end{disclosurebox}
        \end{document}
