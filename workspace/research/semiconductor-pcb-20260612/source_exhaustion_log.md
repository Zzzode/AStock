...
|---|---|---|---|
| Official annual reports | `workspace/reports/semiconductor-pcb-official-filings-20260615/`, `workspace/reports/semiconductor-pcb-watchlist-official-filings-20260615/` | Segment/application revenue and anonymous top customers are disclosed; named customers are not. | Cannot derive NVIDIA/Google/ASIC named revenue split. |
...
| IR records | `workspace/reports/semiconductor-pcb-ir-20260615/`, `data/ir_platform_chain_summary.md` | Platform comments are available; exact customer revenue not disclosed. | Useful for platform evidence, insufficient for named revenue split. |
