...
| Risk | Why it matters | Observable trigger | Report response |
|---|---|---|---|
...
| Risk | Monitoring |
|---|---|
| Customer concentration | NVIDIA chain, North American CSP ASIC chain, domestic compute customer share and qualification status. |
| Material pass-through lag | CCL price trend versus PCB maker gross margin and order ASP. |
| Certification and yield | M9 CCL, high-layer PCB, ABF/BT substrate, CBF material and 24-layer+ FC-BGA progress. |
| Source quality | Availability of original filings, full broker PDFs, and company disclosures. |
| Geopolitics and export controls | Export restrictions, domestic substitution policy, overseas factory execution. |

## Invalidation Conditions

1. AI server and ASIC capex indicators weaken for two consecutive quarters while PCB/CCL capex continues expanding.
2. CCL M8/M9 tightness reverses into broad price cuts.
3. Core names miss revenue or margin expectations despite strong sector narrative.
4. Customer/project exposure is contradicted by company disclosures or later verified sources.
5. Market prices rise while evidence quality remains unchanged and implied valuation exceeds the upper scenario.
