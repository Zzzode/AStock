...
需求侧公开证据继续强化。Alphabet 2026Q1公告显示 Google Cloud 收入同比增长63\%至200亿美元，增长由企业AI解决方案和AI基础设施拉动，且Q1购置物业和设备356.74亿美元；Amazon 2026Q1官方稿显示AWS收入同比增长28\%至376亿美元，自由现金流下降主要来自物业和设备购置同比增加593亿美元，且主要反映AI投资，并披露Trainium、NVIDIA GPU和AI芯片部署；Meta 2026Q1电话会披露资本开支198亿美元，由服务器、数据中心和网络基础设施驱动，并将2026全年资本开支指引上调至1250--1450亿美元。上述证据可以证明AI基础设施CAPEX仍是需求驱动，但不能映射为任何PCB/CCL公司的具名客户收入、订单、ASP或EPS贡献。

\begin{exhibitbox}[图表10: Platform-chain bridge and corpus gaps]
\footnotesize
...
\bottomrule
\end{tabularx}
\sourcenote{\texttt{analysis/customer\_chain\_bridge.md}; \texttt{data/hyperscaler\_capex\_ai\_infrastructure\_evidence\_20260618.md}; hyperscaler capex supports demand bridge only, not supplier revenue allocation}
\end{exhibitbox}
...
\begin{exhibitbox}[图表10b: Named platform revenue split confirmation pack]
\footnotesize
...
\bottomrule
\end{tabularx}
\sourcenote{\texttt{data/named\_platform\_customer\_revenue\_split\_confirmation\_pack\_20260618.md}; \texttt{data/official\_filing\_segment\_summary.md}; \texttt{data/customer\_disclosure\_boundary\_evidence.md}; direct confirmation pack, not completed revenue evidence}
\end{exhibitbox}
...
\begin{exhibitbox}[图表11: Company bridge from chain exposure to verification]
\footnotesize
...
\begin{exhibitbox}[图表12: Quantified platform-to-company bridge from downloaded PDFs]
\footnotesize
\begin{description}
  \item[沪电股份] 2025数通PCB收入146.56亿元，高速交换机81.69亿元，AI服务器/HPC 30.06亿元；2026Q1收入62.14亿元、净利12.42亿元；2025高速交换机和AI服务器相关产品约占收入59\%。2026年6月IR补充泰国数通事业部海外客户认证超70\%、产能利用率超90\%，并加速AI服务器与高速网络产品导入交付。CNInfo/深交所互动易原始接口显示，公司对Rubin、谷歌、NVIDIA/AMD/海外云厂商供货比例、LPU/LPX和国产算力客户等具体厂商问题，均以商业政策限制为由不予讨论；2026年6月18日互动易局部刷新进一步补充高端PCB定价随技术价值、质量溢价和供需动态调整，CoWoP/mSAP/光铜融合/M10仍有研发周期和商业化风险，泰国基地正从爬坡期迈入规模化运营期。缺口：AI客户份额和单机价值量仍未披露。
  \item[胜宏科技] 2026Q1收入55.19亿元、归母净利12.88亿元；2026年6月IR披露具备100层以上高多层PCB、10阶30层HDI、16层任意互联HDI能力，下一代14阶36层HDI推进研发认证；CNInfo/深交所互动易原始接口确认ASIC相关客户业务进展顺利、1.6T光模块mSAP产能用于满足订单且在手订单饱满，同时对NVIDIA Spark、midplane、mSAP/正交背板、CB300、国内芯片、Tesla AI5、GB200/GB300和CoWoP等具体客户/项目问题以商业政策限制为由不披露；局部刷新确认惠州厂房四分阶段投产、厂房十/十一及泰国工厂建设按计划推进。缺口：AI数据中心UBB/交换机客户收入占比未披露。
...
\begin{exhibitbox}[图表12d: H-share prospectus customer evidence]
\footnotesize
\begin{description}
...
H股文件强化了客户集中度判断：AI订单越强，客户集中度往往越高，这既是增长来源，也是估值折扣来源。对胜宏科技和鹏鼎控股尤其如此，客户集中度可以解释盈利弹性，也意味着一旦大客户节奏变化，利润和估值会同步受压。

\begin{exhibitbox}[图表12e: Shengyi Electronics anonymized AI-server customer bridge]
\footnotesize
...
\begin{exhibitbox}[图表12b: Official named customer-chain evidence from watchlist filings]
\footnotesize
\begin{description}
...
\end{description}
\sourcenote{\texttt{data/official\_named\_customer\_chain\_evidence.md}; official 2025 annual report of 南亚新材（688519）}
\end{exhibitbox}

\begin{exhibitbox}[图表12c: Watchlist customer and supplier concentration]
\footnotesize
...
\begin{exhibitbox}[图表12c-2: Watchlist product-customer bridge from official filings]
\footnotesize
...
\bottomrule
\end{tabularx}
\sourcenote{\texttt{data/watchlist\_product\_customer\_bridge.md}; official 2025 annual report inquiry response for 南亚新材（688519）; official 2025 annual report for 芯碁微装（688630）}
\end{exhibitbox}

\begin{exhibitbox}[图表12c-3: Additional watchlist segment-customer evidence]
\footnotesize
\begin{tabularx}{\textwidth}{L{1.8cm}X X X}
\toprule
...
\bottomrule
\end{tabularx}
\sourcenote{\texttt{data/watchlist\_product\_customer\_bridge.md}; official 2025 annual reports for 兴森科技（002436）, 大族数控（301200）, 劲拓股份（300400） and 鼎泰高科（301377）}
\end{exhibitbox}

\begin{exhibitbox}[图表12f: Watchlist IR technology and customer-validation refresh]
\footnotesize
\begin{description}
...
\begin{exhibitbox}[图表12g: Pengding HKEX filing customer and technology evidence]
\footnotesize
\begin{description}
...
\begin{exhibitbox}[图表12h: Customer-side official supplier-list evidence]
\footnotesize
...
\bottomrule
\end{tabularx}
\sourcenote{\texttt{data/microsoft\_top100\_supplier\_pcb\_evidence\_20260617.md}; \texttt{data/opensupplyhub\_customer\_network\_evidence\_20260617.md}; \texttt{data/opensupplyhub\_expanded\_supplier\_evidence\_20260618.md}; \texttt{data/upstream\_supplier\_list\_evidence\_20260618.md}; \texttt{data/customer\_annual\_risk\_disclosure\_recheck\_20260618.md}; \texttt{data/customer\_form\_sd\_conflict\_minerals\_recheck\_20260618.md}; \texttt{data/customer\_purchase\_commitment\_matrix\_20260618.md}; customer-side official / supply-chain network evidence, not revenue split}
\end{exhibitbox}

\begin{exhibitbox}[图表13: Official filing segment evidence]
\footnotesize
\begin{description}
...
\begin{exhibitbox}[图表15: IR records improve platform-chain evidence]
\footnotesize
\begin{description}
  ...
  \item[胜宏科技（300476）] 2026年6月IR称AI服务器PCB 2024--2029 CAGR 18.7\%，AI服务器HDI CAGR 29.6\%；具备100层以上高多层PCB、10阶30层HDI、16层任意互联HDI；ASIC客户进展顺利，GPU加速卡和TPU配套板供应规模扩大；1.6T光模块mSAP产线在手订单饱满。缺口：未披露具体客户或ASIC/NVIDIA平台收入。
...
\begin{exhibitbox}[图表14: Official top-5 customer concentration]
\small
...
\begin{exhibitbox}[图表15: Anonymous top-customer detail from filings]
\footnotesize
...
胜宏科技（300476） & 第一名28.87亿元/14.97\%；第二名24.23亿元/12.56\%；第三名18.37亿元/9.52\%；第四名5.20亿元/2.70\%；第五名4.31亿元/2.23\%。 & 前三客户贡献明显，订单节奏敏感。 \\
...
\begin{exhibitbox}[图表16: Anonymous top-supplier detail from filings]
\footnotesize
\begin{tabularx}{\textwidth}{L{1.8cm}X X}
\toprule
