...
14d的利用率snapshot回答的是"当前产能是否被需求吃满"——沪电整体利用率99.1\%、胜宏HDI 97.7\%已近满产，客观上支撑了扩产必要性。但利用率是结果而非承诺：它只说明存量产能紧张，不保证新投产产能能被同等ASP和毛利率的客户填满。下一表（14e）用IR披露、再融资问询回复和可行性报告回答更关键的问题：新增产能投向哪条产品线、何时投产、客户认证推进到哪一步——这些才决定capex能否转化为EPS增厚，而非仅转化为折旧拖累。两表合起来构成"需求紧张 $\rightarrow$ 扩产有据 $\rightarrow$ 客户/订单可验证"的递进证据链，缺任一环都会让capex叙事回到期权属性。
