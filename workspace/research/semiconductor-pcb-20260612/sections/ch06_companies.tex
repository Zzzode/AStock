...
上表5家为Core/Aggressive底仓，但AI PCB价值链远不止PCB板厂一环。下面把第二批12个扩充标的压缩成短卡片，按\textbf{核心候选（Core Candidate）}、\textbf{观察名单（Watchlist）}与\textbf{需求指标（Demand Anchor，非估值标的）}三档定位。短卡片刻意不做单页化处理——它们的证据密度尚不足以承载目标价，仅用于产业链覆盖补强与后续升级跟踪。
...
\bottomrule
\end{tabularx}
\sourcenote{12标的证据卡：\texttt{data/dongshan\_002384\_evidence.md}\,/\,\texttt{foxconn\_industrial\_601138}\,/\,\texttt{honghe\_603256}\,/\,\texttt{dongcai\_601208}\,/\,\texttt{coresource\_688630}\,/\,\texttt{jingwang\_603228}\,/\,\texttt{zhongji\_300308}\,/\,\texttt{zhongcai\_002080}\,/\,\texttt{kingboard\_01888}\,/\,\texttt{tongguan\_301217}\,/\,\texttt{rongda\_300576}\,/\,\texttt{jinan\_002636}；财务口径同源AkShare结构化（20260331），港股01888为公开转载；估值倍数为各卡推算/聚合值，非交易所直发}
\end{exhibitbox}
...
证据卡给出的排序是：深南和沪电更适合作为核心跟踪底仓候选，生益科技取决于材料价格和M8/M9代际兑现，胜宏科技适合在客户订单和估值回落时提高进攻权重，华正新材则必须等小利润基数修复和CBF/BT订单真正落地。\textbf{12个扩充标的中，东山/景旺/芯碁已具备升格为核心候选的初步证据，可纳入跟踪组合的卫星仓位；其余9个维持观察名单或需求锚定位，需待半年报现金流修复、AI收入进入分部、或客户链具名披露后再评估升级。}
...
\textbf{在扩充12标的后，该核心排序不变，但新增核心候选层：}东山精密（PCB百强\#2 + 光模块/光芯片纵向栈）、景旺电子（FPC软硬结合板 + 1.6T光模块PCB已出货 + 泰国2026放量）、芯碁微装（全球直接成像\#3 + 2026Q1三表同步跳升、OCF转正）三家具备与一线板厂/CCL龙头相近的证据密度或现金流拐点，建议作为Core底仓之外的\textbf{核心候选卫星仓}，权重低于深南/沪电/生益但高于其余9个观察名单标的；铜冠铜箔、东材科技、宏和科技、中材科技、容大感光、金安国纪、建滔积层板七家维持观察名单（其中金安国纪为公司主动澄清无AI敞口的"概念错配"风险反例，建滔为港股AH锚不作A股持仓）；工业富联与中际旭创定位为\textbf{需求指标股而非估值标的}，用于校准AI capex向高端PCB/CCL拉货的传导节奏，不进入本章目标价排序与下一章估值中枢表。该排序与下一章估值模型的目标价、EPS敏感性区间显式对齐，是本章从证据卡到投资结论的收口。
