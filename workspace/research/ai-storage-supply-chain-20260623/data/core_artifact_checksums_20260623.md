# AI 存储产业链 · 核心工件校验和（R239 · 14 files）

> Stage=amend_final · SHA三相闭环中。双后缀 20260623（硬编码锚）+ 20260624（当日归档）。

|#|文件名|SHA-256[:12]|字节数|分类|
|---|---|---|---|---|
|1|main.pdf|`5ab63efa76ea`|907,898|core_output|
|2|main.tex|`90d28bf95a28`|4,945|core_output|
...
|10|source_registry.md|`f85dbdb1bbc2`|18,139|governance|
|11|source_registry.json|`4ee819ddaa3d`|60,728|governance|
|12|claim_audit.md|`a87e6bdbcc40`|21,300|governance|
