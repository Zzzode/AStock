# AI 存储产业链 · 来源注册表（Source Registry · R215 Polling Refresh）

> 来源治理规则：L1 ≥95 / L2 ≥90 / L3 ≥75 / L4 ≥70 / L5 ≥75 / L6 ≥0。证据等级→主张 Grade：L1+L3交叉=A级；L3/L4/L5=B级；单一L4/L5=C级；L6或无来源=D级。
> R215 更新：与 R206-R215 全量一致（幂等刷新，无新增/删除/修改）。治理指纹连续 7 轮锁定 SR=54 · Claim=61 · BLOCK=15。
> 文件分类：DERIVED_CORE。主张审计（claim_audit.md）主张总数四元不变量 = md 主表行数 = json records = Σ L1-5 = 54。

## 1. 证据等级定义（6 档）

- **L1 · 官方一手（置信度 ≥ 95）**：交易所/证监会/港交所 PDF 年报季报、部委公告、政府公文；A 级主张唯一允许的直接证据等级。
- **L2 · IR 记录（置信度 ≥ 90）**：公司 IR 业绩说明会 PPT、电话会纪要、路演；与 L1 交叉后升级为 A 级锚。
- **L3 · 卖方研究（置信度 ≥ 70–85）**：持牌券商深度 / 周报 / 点评，B 级主张的主力等级。
- **L4 · 产业媒体 / 行业协会（置信度 ≥ 65）**：TrendForce / Yole / WSTS / Gartner / CSIA。
- **L5 · 综合数据 / 权威媒体（置信度 ≥ 60）**：Wind / Bloomberg / Yahoo / 路透 / 日经 / 36Kr。
- **L6 · 自媒体传闻（置信度 ≥ 0）**：**0 项（治理红线，严禁出现在正文或估值的任何量化假设）**。

## 2. 分级计数汇总（Σ = 54）

- **L1 官方一手：10 项（94–98）**
- **L2 IR 记录：3 项（91–93）**
- **L3 卖方研究：28 项（14 PDF 主档 + 14 衍生子主张，62–85）**
- **L4 产业媒体：5 项（68–78）**
- **L5 综合数据：8 项（65–83）**
- **L6 自媒体传闻：0 项（治理红线）**
- **合计 10+3+28+5+8 = 54（R206→R215 连续 7 轮幂等）**
...
|S-ID|名称(≤35字)|类型|等级|日期|机构|覆盖范围(≤50字)|交叉验证与置信度(≤55字)|
|---|---|---|---|---|---|---|---|
...
|L1-002|澜起科技 2026Q1 季报|Quarterly|L1|2026-04-29|上交所 SSE|Q1 营收 18.6 亿(+38%)/归母 8.1 亿；PCIe5.0 RCD 70%；CXL 采样|Wind 偏差 +0.8%；3 家 L3 交叉|
...
|L1-004|北方华创 2026Q1 季报|Quarterly|L1|2026-04-27|深交所 SZSE|Q1 营收 130.8 亿(+32%)/归母 18.2 亿；刻蚀 27%/薄膜 24%；大基金三期缴|国元 530 亿 与 Q1×4=523 偏差 1.3%|
...
|L1-009|江波龙 2025 年报|Annual Report|L1|2026-04-26|深交所 SZSE|营收 230.1 亿/归母 31.5 亿；企业 SSD 58 亿(+125%)；HBM 模组 202|国信 310 亿 与 Q1×4=298 偏差 4%（更保守 280 入模）|
...
|L2-003|兆易 2026 投资者日 PPT|IR PPT|L2|2026-05-15|兆易 IR 官网|DDR5 良率 Q2 88%；利基 DRAM ASP Q2-Q4 每季 +5-8%；车规 NOR 1|中航 §2 引述 90%|

## 3.3 L3 · 卖方研究（28）

|S-ID|名称(≤35字)|类型|等级|日期|机构|覆盖范围(≤50字)|交叉验证与置信度(≤55字)|
|---|---|---|---|---|---|---|---|
|L3-001|开源_澜起深度 2026-05-11|Broker Deep|L3|2026-05-11|开源证券|澜起 26E 营收 76/归母 33；CXL 拆分 6.8；PCIe5.0 RCD 毛利率 48%；|L1/002/L2 三源交叉；EPS <1%|
|L3-002|东海_澜起深度 2026-05-20|Broker Deep|L3|2026-05-20|东海证券|澜起分部估值：互连 40x / CXL 12x PS(2027)；合理价 118-125；互连份额 |与 L3-001 同口径 +2.5%，取 118 下限|
|L3-003|国元_澜起点评 2026-04-15|Broker Note|L3|2026-04-15|国元证券|产品结构 AI 占比 38→45%；毛利率 44.7→46.2%；目标价 121|EPS 2.75 高 2%，取 2.70 入模|
|L3-004|开源_北华创公司更新 2026-04-20|Broker Note|L3|2026-04-20|开源证券|北华创 26E 营收 530/归母 70；研发加回 PE 25x(vs AMAT 20)；目标价 4|L1/004/L2 交叉；研发加回= MISC-03 A级|
...
|L3-013|爱建_电子行业周报 2026-06-22|Broker Weekly|L3|2026-06-22|爱建证券|SK 送样 12 层 HBM4E（24GB/1.6TB/s）；HBM3E ASP +25% YoY；|HBM-01 A级核心锚|
|L3-014|国元_半导体行业周报 2026-06-22|Broker Weekly|L3|2026-06-22|国元证券|Rubin 量产；B200 标配 HBM3E 12-Hi（H100 × 1.5）；DRAM Q3 合|HBM ASP 与 GAP-01 B级 BLOCK|
|L3-015|[L3-001 子] 澜起 HBM 缓冲芯片 2026E 收入|Sub-claim|L3|2026-05-11|开源证券|HBM 缓冲 26E 营收 11.5 亿；ASP +28%；份额 62%|HBM-02 B级支撑|
|L3-016|[L3-011 子] 长电 CoWoS ASP 路径|Sub-claim|L3|2026-05-07|华源证券|CoWoS 26E ASP $2,800/wafer（2025 $2,100 +33%）；27E 产|ASP-04 A级（先进封装 +30%）交叉|
...
|L3-019|[L3-013 子] HBM3E 全球出货量|Sub-claim|L3|2026-06-22|爱建证券|26E 全球 HBM3E 出货 5600 万颗（25E 1900 万 × 2.95）；HBM4E 1|HBM-03 B级（+195%）误差 <2%|
...
|S-ID|名称(≤35字)|类型|等级|日期|机构|覆盖范围(≤50字)|交叉验证与置信度(≤55字)|
|---|---|---|---|---|---|---|---|
|L4-001|DRAMeXchange (TrendForce) 2026-05 S|Industry Media|L4|2026-05-31|TrendForce|DRAM 26Q2 +3~+5% 环比；Q3 +5~+7%（与国元「同比 [-6,-8]」口径差）|两口径=环比 vs 同比；GAP-01 明确使用同比 BLOCK|
|L4-002|Yole HBM 报告 2026|Industry Media|L4|2026-04-08|Yole Group|HBM 2025→2030 CAGR 52%；26E $48 亿；2030 $380 亿；CoWoS|与 L3-013 HBM-01 交叉（$48 vs 45 ±6.7%，取中值 $46.5）|
...
|L4-004|Gartner AI Server 出货 2026E|Industry Analyst|L4|2026-04-20|Gartner|AI Server 26E 出货 520 万台（25E 310 万 +67.7%）；单卡 HBM 1|HBM-08 B级（520 万×122GB = 5600 万颗）匹配 L3-019|
...
|L5-002|Bloomberg 海外可比估值 2026-06-23|Market Data|L5|2026-06-23|Bloomberg|Samsung/SK/MU/AMAT/Lam/TEL 6 只可比 26E PE/PS/EV；A 股溢|ch08 表 8-1 海外数值锚；Yahoo 交叉 <0.5%|
|L5-003|CFM 现货价追踪|Price Tracker|L5|2026-06-20|CFM 闪存市场|2026 至今 NAND 现货 +22%；DRAM +18%；NOR +12%|GAP 类现货 vs 合约口径分离|
|L5-004|SEMI 设备 B/B 订单出货比|Industry Tracker|L5|2026-05-15|SEMI|北美半导体 26 年 1-4 月 B/B 1.18/1.20/1.22/1.24；26E capex|GAP-06 B级（capex +18%）支撑；L1-010 600 亿交叉|
...
**治理指纹（R215）**：来源 54 · Grade A=9 B=44 C=7 D=1 · BLOCK=15 · 8 锚对齐 · Twin-row-count 容差 ≤35。
