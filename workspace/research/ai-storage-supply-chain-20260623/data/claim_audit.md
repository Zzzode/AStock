# AI 存储产业链 · 主张审计表（Claim Audit · R220 Polling Refresh · 第15轮）

> 治理规则：Grade A = L1 + L3 交叉（≥2 源）/ 算术恒真断言；Grade B = 单一 L3 或 L4/L5；Grade C = 间接推断 / 单一 L4；Grade D = 不可信。C/D 进入估值必须 BLOCK。
> 治理指纹（R220）：61 主张 · Grade A=9 / B=44 / C=7 / D=1 · BLOCK 门控=15（数据级 11 + 治理锚 4）。连续 15 轮 R206→R220 不变。
...
> 3 ASP 核心锚（+35% HBM ASP / +30% 先进封装 / +18% 利基DRAM）+ 3 标的营收交叉锚（EXP-01/03/04）+ HBM-01 26E $46.5 亿全球市场 + MISC-03 研发加回算术恒真 PE + MISC-06 B7+ 全报告区间化治理字面。

## §1. Grade 定义

|Grade|证据要求|允许进入基准估值|典型来源|
|---|---|---|---|
|A|L1 + L3 ≥2 源交叉；或算术恒真 / 治理锚字面|唯一允许的核心量化锚|上交所/深交所 PDF + 持牌券商深度交叉|
|B|单一 L3 卖方研究；或 L4/L5 权威媒体|允许（BLOCK 区间化声明生效）|14 份 L3 PDF / TrendForce / Yole / Bloomberg|
|C|间接推断；单一 L4；自媒体转述|禁止进入基准估值，BLOCK 留痕|36Kr / Yole 单点 / 位宽推导|
|D|无来源 / 已证伪 / 传闻|严禁，BLOCK 强阻断|无来源拍脑袋|
...
> 数据级 11：GAP-01 B追踪 / GAP-04 D / ASP-06 B追踪 / HBM-04 C / HBM-11 B追踪 / HBM-14 C / HBM-20 C / HBM-21 C / MISC-09 C / MISC-10 C / MISC-14 C
> 治理锚 4：B7（江波龙 EPS [17.1,31.7] 区间化 · ch08:139）/ B7+（全报告区间化声明 · ch08:145）/ B8（国产化率35%+大基金600亿 · ch07:88）/ S-3（北华15%·中微9%·拓荆≤6% 权重纪律 · ch11:77，Σ=100%）
...
|---|---|---|---|
|V-1|C/D 级主张未声明 BLOCK 即进入估值=阻断发布|S 级阻断|61 主张：7C+1D 全部 BLOCK 留痕 ✓|
|V-2|A 级主张证据链 <2 源=降级至 B|A→B|A=9 全部 ≥2 源（MISC-03/06 三源交叉）✓|
|V-3|估值表任何单点 EPS/Price 未区间化=BLOCK 强阻断|BLOCK 治理锚|B7/B7+ ch08 行139/145 落实区间化 ✓|
|V-4|BLOCK 项总数 <10=治理不充分|PASS/FAIL 门控|BLOCK=15≥10 ✓|
|V-5|权重合计≠100% 或 北华15%·中微9%·拓荆≤6% 三约束未双向表述|S 级|ch11 S-3 治理锚（60% 核心三层权重纪律）✓|
...
|---|---|---|---|
|B1 (DRAM Q3 [-6,-8])|GAP-01 / GAP-02|Grade B（BLOCK 追踪）|ch05 行153|
...
|B9 (江波龙 乐观×0.7 折扣)|EXP-04|L3 分位数统计|ch08 行146|
|B13 (情景 Σ=100% <5% 联合)|MISC-15|A 级算术恒真|ch10 行47|
|S-3 (北华 15% · 中微 9% · 拓荆 ≤ 6%)|MISC-BLOCK 15|治理锚 A 级|ch11 行77|
|S-0 (仓位合计=100%)|MISC-15|算术恒真|ch11 行55|

---

**治理指纹 R220**：61 主张 · Grade 9/44/7/1 · BLOCK=15 · 8 锚对齐 · V-1~6 全合规 · Verifier 双稳态 PASS=108/0/2。
