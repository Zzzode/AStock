...
\begin{tabularx}{\linewidth}{>{\bfseries}l l >{\centering}p{1.0cm} >{\raggedleft}p{0.9cm} >{\raggedleft}p{0.8cm} >{\raggedleft}p{0.8cm} >{\raggedleft}p{0.8cm} l}
\toprule
...
\bottomrule
\multicolumn{8}{p{\linewidth}}{\scriptsize 数据来源：各公司 2025 年报 + 2026Q1 财报；AI 敞口为 {\faExclamationTriangle} AStock 模型估算 (非官方披露)；2026E PE 基于 Wind 一致预期 + 本报告盈利预测校准；完整版 23 只含 20+ 列详见附录 C 表 C-1。}
\end{tabularx}
\end{exhibitbox}
