...
\textbf{中微/通富/深科技} & — & — & \multicolumn{3}{c}{\textbf{\faExclamationTriangle 近90天无卖方PDF覆盖}} & 本次Web搜索可用度极低 (10次查仅1次返回)；强烈建议下一轮定向补采东方财富研报中心 \\
\bottomrule
\end{tabularx}
\end{exhibitbox}
