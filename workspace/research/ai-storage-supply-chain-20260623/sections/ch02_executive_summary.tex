...
\vspace{0.3em}
\textbf{核心论点二：设备/材料是最确定的「二阶 Beta」，澜起是唯一的「一阶 Alpha」。}
不论 HBM 竞争格局谁赢谁输，三大原厂 + YMTC/CXMT 合计 \$1200 亿+ 的 2026E capex 必然流向半导体设备和材料。北方华创 (平台化刻蚀/薄膜)、中微公司 (3D NAND 介质刻蚀 + TSV)、拓荆科技 (ALD/CVD) 三家在 YMTC/CXMT 的份额已从 2023 年的 <10\% 快速提升至 2026E 的 20-35\%，叠加 BIS 管制下的国产化刚性替代，确定性高于任何设计端标的。澜起科技则凭借 DDR5 RCD 全球 约70\% 份额 + CXL 内存扩展控制器卡位，成为 A 股唯一直接受益于 AI 服务器单机内存量价齐升的「一阶 Alpha」标的。\par
\vspace{0.3em}
...
\begin{tikzpicture}[
  ...
  subp/.style={rectangle, rounded corners=2pt, minimum width=3.0cm, minimum height=0.8cm, align=center, draw=#1!70, fill=#1!5, font=\scriptsize, inner sep=2pt},
...
\node[draw=deepnavy, fill=deepnavy, text=white, rounded corners=4pt, minimum width=9cm, minimum height=1.1cm, align=center, font=\bfseries\normalsize] (CONCL) at (4.5, -3.4) {AStock 结论：2026H2-2027 量价齐升双击 · 核心组合目标回报 +25-40\%};
...
\centering
\small
\begin{tabularx}{\linewidth}{>{\raggedright}p{2.4cm} >{\raggedright}p{5.6cm} >{\raggedright\arraybackslash}X}
\toprule
...
\centering
\small
\begin{tabularx}{\linewidth}{c >{\raggedright}p{8.0cm} c >{\centering\arraybackslash}p{2.0cm} l}
\toprule
