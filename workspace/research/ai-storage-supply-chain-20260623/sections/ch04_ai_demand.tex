...
\node[ashare, fill=white, draw=riskred, text=deepnavy] (P2) at (3.8, -4.4) {Pool B · Type 3\\★ \textbf{CXL MXC 控制器}\\澜起全球首发量产};
\node[pool] (P3) at (7.3, -4.4) {Pool C · Tiering\\热 DDR5 · 冷 CXL SSD\\Samsung · Solidigm};
\node[ashare, fill=white, draw=riskred, text=deepnavy] (P4) at (10.8, -4.4) {Pool D · 模组/SSD\\★ \textbf{江波龙 / 深科技}\\CXL 模组研发中};
