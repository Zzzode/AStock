...
\centering
\footnotesize
\begin{tabularx}{\exhibitboxwidth}{>{\bfseries}c >{\raggedleft}p{1.1cm} >{\raggedleft}p{1.1cm} >{\raggedleft}p{1.1cm} >{\raggedleft}p{1.3cm} >{\raggedleft}p{1.2cm} >{\raggedright\arraybackslash\hspace{0pt}}X}
\toprule
\textbf{年份} & \textbf{出货\\(亿GB)} & \textbf{均价\\ASP(\$/GB)} & \textbf{TAM\\(亿\$)} & \textbf{YoY(\%)} & \textbf{主力代(价值占)} & \textbf{核心驱动} \\
\midrule
...
\centering
\footnotesize
\begin{tabularx}{\exhibitboxwidth}{>{\bfseries}l >{\raggedleft}p{1.5cm} >{\raggedleft}p{1.5cm} >{\raggedleft}p{1.6cm} >{\raggedleft}p{1.3cm} >{\raggedright\arraybackslash}X}
\toprule
