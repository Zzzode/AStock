...
本报告覆盖 AI 叙事驱动的全球存储产业链，核心观点为：2026H2-2027 年 A 股存储链有望迎来「量价齐升 + 格局重塑」双击。HBM 扩容、DDR5 渗透、CXL 商业化与国产替代四主线共振，预计核心组合 2026E 净利加权增速 43\%，当前估值处近三年 40-60\% 分位，上行空间 \textbf{0--18\%}（基准情景 · 三角恒等校准后），江波龙 / 深科技为弹性首选，设备三强赔率因估值上行已显著收窄。
...
\midrule
\rowcolor{navy!6}
核心 Core & 澜起科技 688008 & DDR5 RCD + CXL & 18\% & 42x & +5 & \stance{riskgreen}{买入} & CXL 3.0 出货 >50 万颗 & RCD 市占率跌破 30\% \\
\rowcolor{navy!6}
& 北方华创 002371 & 刻蚀 / 薄膜平台 & 18\% & 41x & +9 & \stance{riskgreen}{买入} & 在手订单 >12 月 & 存储厂 capex 下修 >20\% \\
\rowcolor{navy!6}
& 中微公司 688012 & CCP / TSV 刻蚀 & 14\% & 48x & +3 & \stance{riskgreen}{买入} & HVM TSV 订单确认 & 先进封装需求下滑 \\
\midrule
卫星 Satellite & 拓荆科技 688072 & ALD / CVD 薄膜 & 10\% & 55x & $\sim$0 & \stance{accentblue}{增持} & ALD 在长存份额 >15\% & 美光 / 海力士替代延迟 \\
...
& 江波龙 301308 & 企业级 SSD / 模组 & 7\% & 18x & +18 & \stance{riskgreen}{买入} & 头部云厂商导入 & 利基存储涨价不及预期 \\
& 兆易创新 603986 & NOR + 自研 DRAM & 5\% & 36x & +10 & \stance{accentblue}{增持} & 自研 DRAM 出货 >1 亿颗 & 长鑫协议恶化 \\
\midrule
主题 Theme & 南大光电 300346 & ArF 光刻胶 / 前驱 & 3\% & 48x & +30 & \stance{riskamber}{观察} & ArF 光刻胶长存验证通过 & KrF 替代不及预期 \\
\midrule
\rowcolor{panelgrey}
\multicolumn{2}{>{\cellcolor{panelgrey}\bfseries}p{3.6cm}}{\textbf{组合合计 (12 只)}} & & \textbf{100} & \textbf{42x} & \textbf{+8 (加权)} & \multicolumn{3}{>{\cellcolor{panelgrey}\raggedleft\arraybackslash}p{6.3cm}}{\textbf{基准情景 · 持有期 6-12 月 · 三角恒等校准}} \\
\bottomrule
\end{tabularx}
\end{exhibitbox}
