...
本报告覆盖 AI 叙事驱动的全球存储产业链，核心观点为：2026H2-2027 年 A 股存储链有望迎来「量价齐升 + 格局重塑」双击。HBM 扩容、DDR5 渗透、CXL 商业化与国产替代四主线共振，预计核心组合 2026E 净利加权增速 43\%，当前估值处近三年 40-60\% 分位，上行空间 \textbf{0--18\%}（基准情景 · 三角恒等校准后；上行空间指纯估值收敛(FV/CP-1不含EPS增长；持有期总回报含盈利增长见第10章情景B目标回报+25-40%)），江波龙 / 深科技为弹性首选，设备三强赔率因估值上行已显著收窄。

\begin{exhibitbox}[表 1-1 \quad 推荐组合与评级一览 / Recommended Portfolio \& Ratings]
\centering
\scriptsize
\renewcommand{\arraystretch}{1.2}
\begin{tabularx}{\exhibitboxwidth}{>{\bfseries}p{1.2cm} >{\raggedright}p{2.4cm} p{1.7cm} >{\raggedleft\arraybackslash}p{0.75cm} >{\raggedleft\arraybackslash}p{0.7cm} >{\raggedleft\arraybackslash}p{0.8cm} >{\centering\arraybackslash}p{1.1cm} >{\raggedright\arraybackslash}p{2.1cm} >{\raggedright\arraybackslash\hspace{0pt}}X}
\toprule
\textbf{层级} & \textbf{标的 / 代码} & \textbf{环节} & \textbf{权重} & \textbf{26E PE} & \textbf{上行} & \textbf{评级} & \textbf{买入触发} & \textbf{失效条件} \\
\midrule
\rowcolor{riskred!10}
核心 Core & 澜起科技 688008 & DDR5 RCD + CXL & 22\% & 42x & +5 & \stance{riskgreen}{买入} & CXL 3.0 出货 >50 万颗 & RCD 市占率跌破 30\% \\
\rowcolor{riskred!10}
& 北方华创 002371 & 刻蚀 / 薄膜平台 & 18\% & 41x & +9 & \stance{riskgreen}{买入} & 在手订单 >12 月 & 存储厂 capex 下修 >20\% \\
\rowcolor{riskred!10}
& 中微公司 688012 & CCP / TSV 刻蚀 & 10\% & 48x & +3 & \stance{riskgreen}{买入} & HVM TSV 订单确认 & 先进封装需求下滑 \\
\rowcolor{riskred!10}
& 拓荆科技 688072 & ALD / CVD 薄膜 & 10\% & 55x & $\sim$0 & \stance{riskgreen}{买入} & ALD 在长存份额 >15\% & 美光 / 海力士替代延迟 \\
\midrule
\rowcolor{accentblue!10}
卫星 Satellite & 沪硅产业 688126 & 12 寸硅片 & 6\% & 72x & +22 & \stance{accentblue}{增持} & 14nm 硅片通过验证 & 客户认证推迟 2 季 \\
\rowcolor{accentblue!10}
& 深科技 000021 & 存储模组 + 封测 & 8\% & 24x & +16 & \stance{accentblue}{增持} & 沛顿 DDR5 代工翻倍 & Kingston 订单转移 \\
\rowcolor{accentblue!10}
& 长电科技 600584 & XDFOI 先进封装 & 6\% & 38x & +1 & \stance{accentblue}{增持} & CoWoS 客户突破 & 毛利率连续 2 季 <13\% \\
\rowcolor{accentblue!10}
& 通富微电 002156 & AMD 封测绑定 & 5\% & 32x & +9 & \stance{accentblue}{增持} & MI350 订单确认 & AMD 份额转单 \\
\rowcolor{accentblue!10}
& 江波龙 301308 & 企业级 SSD / 模组（估值真理） & 7\% & 18x & +18 & \stance{riskgreen}{买入} & 头部云厂商导入；Wind 2026-06-24 收盘 CP≈439.4，市值 1846 亿 & 利基存储涨价不及预期 \\
\midrule
\rowcolor{nvgreen!10}
主题 Theme & 兆易创新 603986 & NOR + 自研 DRAM & 5\% & 36x & +10 & \stance{accentblue}{增持} & 自研 DRAM 出货 >1 亿颗 & 长鑫协议恶化 \\
\rowcolor{nvgreen!10}
& 南大光电 300346 & ArF 光刻胶 / 前驱 & 3\% & 48x & +30 & \stance{riskamber}{观察} & ArF 光刻胶长存验证通过 & KrF 替代不及预期 \\
\midrule
\rowcolor{panelgrey}
\multicolumn{2}{>{\cellcolor{panelgrey}\bfseries}p{3.6cm}}{\textbf{组合合计 (11 只)}} & & \textbf{100} & \textbf{42x} & \textbf{+8 (加权)} & \multicolumn{3}{>{\cellcolor{panelgrey}\raggedleft\arraybackslash}p{6.3cm}}{\textbf{Core60\% / Satellite32\% / Thematic8\% · 持有期 6-12 月 · 三角恒等校准}} \\
\bottomrule
\end{tabularx}
\end{exhibitbox}
\sourcenote{估值与目标区间基于卖方一致预期 (Wind + 14 份券商 PDF) 与 AStock 估值模型加权，详见第 8 章表 8-2 与附录 A 估值审计。上行空间 = 合理价值区间中值相对 Wind 2026-06-24 收盘的涨幅；经 PE × EPS = Price 三角恒等校准，原 +25--40\% 乐观区间收窄至 0--18\%。}
...
\vspace{0.4em}
\noindent\textbf{投资含义}：组合采用「哑铃结构」——60\% 核心仓位配置设备三强+接口芯片的「二阶 Beta」(澜起/北方华创/中微/拓荆)，不论 HBM 谁赢都要扩产，确定性最高；32\% 卫星布局封测+模组+硅片的弹性环节；8\% 主题性配置设计与材料。组合整体 2026E 加权净利增速 43\%、加权 PE 42x、PEG 约 0.98，估值未严重透支景气度。

\begin{exhibitbox}[表 1-2 \quad 核心数据速览 / Key Data Dashboard]
\centering
\small
\begin{tabularx}{\exhibitboxwidth}{>{\bfseries}l X >{\raggedleft\arraybackslash}p{3.4cm} l}
\toprule
...
全球存储全链 2026E Capex（原厂+设备+材料）& 约 \$1200 亿，其中三大原厂（Samsung/SK/Micron）合计约 \$850--910 亿 & HBM 相关占比 约30\% & 原厂 CC [S-01/S-02/S-11] + 产业口径 \\
2026Q3 DRAM 供需缺口预测 & 基准-6--8\%（乐观-8--10\%见第10章） & 合约价 QoQ 基准+8~+10\%（乐观+10~+12\%见第10章） & AStock 供需模型 [§5.2] \\
...
\node[rectangle, rounded corners=6pt, draw=deepnavy, fill=deepnavy, text=white, text width=14cm, align=center, minimum height=1.1cm, font=\bfseries] (OUT) at (6.3,-3.6) {2026H2-2027：量价齐升 + 格局重塑双击 · A 股核心组合目标回报 +25--40\%(持有期总回报含EPS增长)};
