...
对 A 股研究而言，BIS 管制本质上是「短期利空原厂产能扩张、长期倒逼设备材料国产化」的双刃剑结构。在 2026-06-26 当前估值模型中，本节作为风险与倍数折扣输入：BIS 规则、ASML 对华交付、长存/长鑫设备中标和国产 AI 芯片出货决定目标价上修/下修方向，但最终配置动作仍以 ch08/ch11 的目标价空间和证据质量为准。\par
