...
对 A 股投资而言，BIS 管制本质上是「短期利空原厂 (产能扩张)、长期利多设备材料 (国产化率强制提升)」的双刃剑结构。配置含义有三：第一，若 Q3 管制落地且超预期 (DUV 全面断供)，应短期规避长存\slash 长鑫供应链敞口集中的标的 (部分设备厂订单延后 1-2 季)，但利用回调加仓国产替代逻辑最硬的北方华创 (刻蚀/薄膜平台化) 和中微 (介质刻蚀全球竞争力)；第二，若管制未落地或力度低于预期，则长存\slash 长鑫的扩产加速将直接利好拓荆 (ALD)、盛美上海 (清洗/电镀) 和安集科技 (CMP) 等弹性设备材料股；第三，无论管制是否升级，澜起科技 (CXL 对冲工具) 和江波龙/深科技 (企业级模组国产替代) 都处于管制受益的结构路径上。\par
